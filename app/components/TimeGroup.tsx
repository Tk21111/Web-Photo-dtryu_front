        ...
        <div className={
            ...
            <div className="flex flex-col space-y-1 my-2">
                <div className="flex flex-row justify-between py-0.5 px-2.5">
                    ...
                    { !isOpen &&<ArrowDownFromLine onClick={() => setIsOpen(!isOpen)} className="bg-gray-800 rounded-2xl w-10 h-8 p-1.5 hover:bg-gray-600 duration-100 "/>}
                    { isOpen && <ArrowUpFromLine onClick={() => setIsOpen(!isOpen)} className="bg-gray-800 rounded-2xl w-10 h-8 p-1.5 hover:bg-gray-600 duration-100 " />}
            ...
            <div className="flex flex-col justify-center py-0.5 px-2.5">
                {isOpen && <ArrowUpFromLine onClick={() => setIsOpen(!isOpen)} className="bg-gray-800 rounded-2xl w-[100%] h-8 p-1.5 hover:bg-gray-600 duration-100 " />}
                {!isOpen && <ArrowDownFromLine onClick={() => setIsOpen(!isOpen)} className="bg-gray-800 rounded-2xl w-[100%] h-8 p-1.5 hover:bg-gray-600 duration-100 " />}
